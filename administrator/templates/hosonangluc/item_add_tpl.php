...
?>
<form name="frm" method="post" action="index.php?com=hosonangluc&act=save" enctype="multipart/form-data" class="nhaplieu">
   ...
   <?php if (@$_REQUEST['act']=='edit')
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=hosonangluc&act=man'" class="btn" />
</form>