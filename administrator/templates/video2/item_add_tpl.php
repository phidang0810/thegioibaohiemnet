...
<form name="frm" method="post" action="index.php?com=video2&act=save" enctype="multipart/form-data" class="nhaplieu">		
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=video2&act=man'" class="btn" />
</form>