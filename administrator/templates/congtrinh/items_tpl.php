<h3><a href="index.php?com=congtrinh&act=add">Thêm đối tác mới</a></h3>
...
<table class="blue_table">
	...
	<tr>
		...
		<td style="width:6%;"><a href="index.php?com=congtrinh&act=edit&id=<?=$items[$i]['id']?>"><img src="media/images/edit.png"  border="0"/></a></td>
