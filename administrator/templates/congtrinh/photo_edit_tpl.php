...
<form name="frm" method="post" action="index.php?com=congtrinh&act=save_photo&id=<?=$_REQUEST['id'];?>&idc=<?=$_REQUEST['idc']?>" enctype="multipart/form-data" class="nhaplieu">	
	<b>&nbsp;</b> 
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=congtrinh&act=man_photo'" class="btn" />
</form>